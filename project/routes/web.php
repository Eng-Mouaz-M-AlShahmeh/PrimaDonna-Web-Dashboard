...
Route::prefix('admin')->group(function() {
  ...
  Route::get('/prem/', 'Admin\DashboardController@index')->name('admin.dashboard');
...
// ************************************ FRONT SECTION **********************************************
  ...
  // HYPERPAY SECTION
  Route::post('/visamaster/', 'Front\HyperpayController@requestVisaMaster')->name('visamaster.submit');
  Route::post('/stcpay/', 'Front\HyperpayController@requestStcpay')->name('stcpay.submit');
  Route::post('/mada/', 'Front\HyperpayController@requestMada')->name('mada.submit');
  
  Route::post('/sms/{orderNum}-{phoneCus}', 'Front\HyperpayController@sendSMS')->name('sms.submit');

  //Route::get('/{amount}-{currency}/hyperpay','Front\FrontendController@hyperpay')->name('front.hyperpay');
  
  Route::get('/{id}/{merchantTransactionId}/hyperpayReq','Front\FrontendController@hyperpayReq')->name('front.hyperpayReq');
  
  Route::get('/{id}/{merchantTransactionId}/hyperpayReqMada','Front\FrontendController@hyperpayReqMada')->name('front.hyperpayReqMada');
