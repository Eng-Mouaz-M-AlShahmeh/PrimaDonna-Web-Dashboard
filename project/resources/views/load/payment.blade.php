<!----------------------------------- start hyperpay section -------------------------->
@if($payment == 'visamaster') 
                                <input type="hidden" name="method" value="Visa Or Master Payment">


@endif

@if($payment == 'stcpay') 
                                <input type="hidden" name="method" value="STC Pay">


@endif

@if($payment == 'mada') 
                                <input type="hidden" name="method" value="MADA Payment">


@endif


<!----------------------------------- end hyperpay section -------------------------->
