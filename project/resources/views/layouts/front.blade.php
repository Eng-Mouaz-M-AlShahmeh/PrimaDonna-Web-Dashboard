...
<script type="text/javascript" src="{{asset('assets/front/js/floating-wpp.js')}}"></script>

<script type="text/javascript">
    $(function () {
        $('#myButton').floatingWhatsApp({
            phone: '966544436501',
            popupMessage: 'مرحبا، كيف يمكنني مساعدتك؟',
            message: "",
            showPopup: true,
            showOnIE: false,
            headerTitle: 'للتواصل معنا عبر الواتساب',
            headerColor: '#2e9e2e',
            backgroundColor: '#2e9e2e',
            position: 'right',
            buttonImage: '<img src="{{asset('assets/front/js/whatsapp.svg')}}" />'
        });
    });
</script>
