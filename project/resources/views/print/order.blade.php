...
<body style="background-color: #ffffff;">
    <div class="invoice-wrap">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="invoice__logo text-left">
                           <img width="30%" src="{{ asset('assets/images/'.$gs->logo) }}" alt="woo commerce logo">
                        </div>
                    </div>
                </div>
            </div>
            <br>
            <div class="invoice__metaInfo rtlll">
                <div class="col-lg-6">
            ...
            <div class="invoice__metaInfo rtlll" style="width: 50%">
                @if($order->dp == 0)
                <div class="col-lg-6">
                        <div class="invoice__orderDetails">
                           ...
                           <span><strong>{{ __('Customer Name') }}</strong>: {{ $order->shipping_name == null ? $order->customer_name : $order->shipping_name}}</span><br>
                              ...
                              <span><strong>{{ __('Customer Phone') }}</strong>: {{ $order->customer_phone == null ? $order->customer_phone : $order->customer_phone}}</span><br>
...
<hr>
                ...
                <div class="col-lg-12 rtlll">
                    <div class="invoice_table">
                        <div class="mr-table">
                            <div class="table-responsive">
                                <table id="example2"  cellspacing="0"
                                    width="100%" style="background-color: #f2f2f2">
            ...
            <div class="invoice__metaInfo rtlll" >
                <div class="col-lg-6">
                        <div class="invoice__orderDetails">
                            ...
                            <p style="font-size: 10px; font-color: #808080; text-align: center;">For inquiries and complaints, please contact us via: 
                            
                            <span>
                                <img src=" {{ asset('assets/images/w123.png') }}" height="20" width="20" class="p-1">
                            </span>
                            966508111069 
                            
                            <span>
                                <img src=" {{ asset('assets/images/e123.png') }}" height="20" width="20" class="p-1">
                            </span>
                            customercare@primadonna-sa.com
                            
                            </p>
                            
                            
                            
                            <p style="text-align: center;">www.primadonna-sa.com</p>
