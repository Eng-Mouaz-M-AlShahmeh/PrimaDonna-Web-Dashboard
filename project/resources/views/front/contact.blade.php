                                ...
                                <div class="social-links">
                                    ...
                                    <ul>
                                     ...
                                     @if(App\Models\Socialsetting::find(1)->f_status == 1)
                                      ...
                                      <li>
                                        <a href="{{ App\Models\Socialsetting::find(1)->gplus }}" class="instagram" target="_blank">
                                      ...
                                      <li>
                                        <a href="{{ App\Models\Socialsetting::find(1)->linkedin }}" class="snapchat" target="_blank">
