                        ...
                        <div class="top-area">
                                <div class="content">
                                    ...
                                    <div class="logo">
                							...
                							<img width="30%"src="{{asset('assets/images/'.$gs->logo)}}" alt="">
     ...
     {{$order->order_note}}
                            ...
                            <table  class="table">
                                ...
                                <tr>
                                     ...
                                     <th width="10%">{{ $langg->lang77 }}</th>
                                    <th width="50%">{{ $langg->lang310 }}</th>
                                    <th width="10%">{{ $langg->lang539 }}</th>
                                    <th width="20%">{{ $langg->lang5380 }}</th>
