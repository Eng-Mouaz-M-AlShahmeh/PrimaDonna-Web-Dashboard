											...
											<div class="row">
												<div class="col-lg-6 {{ $digital == 1 ? 'd-none' : '' }}">
													<select class="form-control" id="shipop" name="shipping" required="">
														...
														<option value="delivery">{{ $langg->lang150 }}</option>
													</select>
												</div>
...
<div class="form-control btn-group input-group-prepend col-lg-3 col-sm-4 col-4" required="">

<input type="hidden" id="phone_icc" value="966" name="phone_icc"></input>

<input type="hidden" id="phone_number" value="" name="phone_number"></input>

<input type="hidden" id="phone" value="" name="phone"></input>


<button style="font-size: 12px;" id="menuLabel2" class="btn dropdown-toggle" data-toggle="dropdown2" aria-haspopup="true" aria-expanded="false" onclick="toggle('dropdown2');">
    <img width="30%" src="{{asset('assets/front/images/flags/'.DB::table('countries')->find(191)->country_flag)}}" alt="">

    {{ DB::table('countries')->find(191)->country_icc }}
</button>
    ...
    overflow-x: hidden; /****** NEW *****/">
        ...
        <div class="dropdown-item" onclick="getValueICC('{{ $data->country_icc }}'); toggle('dropdown2');"> <img width="20%" src="{{asset('assets/front/images/flags/'.$data->country_flag)}}" alt=""> {{ $data->country_icc }} </div>
    ...
    <input id="phone_number1" oninput="getValueNum()" class="form-control col-lg-9 col-sm-8 col-8" type="text" name="phone_number1" placeholder="{{ $langg->lang153 }}" required="" value="">	
      
      {{--  {{ Auth::guard('web')->check() ? Auth::guard('web')->user()->phone : '' }}  --}}   
...
<div class="form-control btn-group" required="">

<input type="hidden" id="customer_country" value="" name="customer_country"></input>

<input type="hidden" id="billing_country" value="SA" name="billing_country"></input>

<button id="menuLabel" class="btn dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true" onclick="toggle('dropdown');">{{ $langg->lang157 }}</button>

    <div class="dropdown-menu" id="dropdown" style="display:none; box-sizing: border-box; /****** NEW *****/
    max-height: 150px;   /****** NEW *****/
    overflow-y: scroll;  /****** NEW *****/
    overflow-x: hidden; /****** NEW *****/">
        ...
        <div class="dropdown-item" onclick="getValue('{{ $data->country_name }}'); getValuee('{{ $data->country_code }}'); toggle('dropdown'); "> <img width="10%" src="{{asset('assets/front/images/flags/'.$data->country_flag)}}" alt=""> {{ $data->country_name }} </div>
												...
												<div class="row">
													<div class="col-lg-12">
														<div class="nav flex-column"  role="tablist" aria-orientation="vertical">
														    ...
														    <a class="nav-link payment" data-val="" data-show="no" data-form="{{route('visamaster.submit')}}" data-href="{{ route('front.load.payment',['slug1' => 'visamaster','slug2' => 0]) }}" id="v-pills-tab1-tab" data-toggle="pill" href="#v-pills-tab1" role="tab" aria-controls="v-pills-tab1" aria-selected="true">
																	<div class="icon">
															...
															<a class="nav-link payment" data-val="" data-show="no" data-form="{{route('stcpay.submit')}}" data-href="{{ route('front.load.payment',['slug1' => 'stcpay','slug2' => 0]) }}" id="v-pills-tab1-tab" data-toggle="pill" href="#v-pills-tab1" role="tab" aria-controls="v-pills-tab1" aria-selected="true">
																	<div class="icon">
																			<span class="radio"></span>
																	</div>
																<p>
															...
															<a class="nav-link payment" data-val="" data-show="no" data-form="{{route('mada.submit')}}" data-href="{{ route('front.load.payment',['slug1' => 'mada','slug2' => 0]) }}" id="v-pills-tab1-tab" data-toggle="pill" href="#v-pills-tab1" role="tab" aria-controls="v-pills-tab1" aria-selected="true">
																	<div class="icon">
																			<span class="radio"></span>
																	</div>
																<p>
...
<script>
    ...
    function getValue(value) {
            ...
            customer_country.value = value;
            document.getElementById("menuLabel").innerHTML = value;
    }
    
    function getValuee(value) {
    ...
    function getValueICC(value) {
            var phone_icc = document.getElementById('phone_icc');
            phone_icc.value = value;
            document.getElementById("menuLabel2").innerHTML = value;
            
            var phone_number = document.getElementById('phone_number');
            var phone = document.getElementById('phone');
            
            phone.value = String(phone_icc.value).concat(" - ", String(phone_number.value));
    ...
    function getValueNum() {
            ...
            var phone_number = document.getElementById('phone_number');
            phone_number.value = phone_number1.value;
