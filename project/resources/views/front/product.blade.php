              ...
              <p class="title">{{ $langg->lang87 }} :</p>
                  ...
                  <div class="social-links social-sharing a2a_kit a2a_kit_size_32">
                    <ul class="link-list social-links">
                        <li>
                        <a style="background: #0166ff;" class="telegram a2a_button_telegram" href="">
                          <i class="fab fa-telegram-plane"></i>
                        </a>
                      </li>
                      <li>
                        <a style="background: #12AF0A;" class="whatsapp a2a_button_whatsapp" href="">
                      ...
                      <li>
                        <a style="background: #DD5347;" class="email a2a_button_email" href="">
